#!/usr/bin/env python
# --- 完整修复 Python 3.10+ 兼容性问题的补丁 ---
import collections
import collections.abc

# 定义需要修复的名称列表
names_to_fix = ['Mapping', 'MutableMapping', 'Sequence', 'MutableSequence', 'Iterable', 'Callable']
...
class Main:
    ...
    def evaluate(self, epoch=0, action='eval'):
        ...
        self.model.load_state_dict(torch.load(PATH, map_location=self.config.device, weights_only=False)['model'])
        self.model.eval()
...
if __name__ == '__main__':
    ...
    parser.add_argument('--use_rope', type=bool, default=True, help='Use Hierarchical RoPE')
